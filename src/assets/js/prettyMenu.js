...
(function ($) {
  $.fn.prettyMenu = function (options) {
    ...
    return this.each(function () {
      ...
      $t.find("> ul")
        .addClass("main")
        .wrap('<div class="pm_menu_container"></div>');
      var mobile;
      ...
      $t.find("ul.main > li")
        .has("> ul")
        .find("> a")
        .append('<i class="fa fa-angle-down arrow"></i>');
      $t.find("ul:not(.main) > li")
        .has("ul")
        .find("> a")
        .append('<i class="fa fa-angle-right arrow"></i>');
      ...
      $t.prepend(
        '<div class="pm_main_mobile"><a class="pm_toggle"><span class="hamburger hamburger--' +
          options.iconStyle +
          '"><div class="hamburger-box"><div class="hamburger-inner"></div></span></div></a></div>'
      );
      ...
      if (options.hoverAnimation)
        $t.find("ul > li > a").addClass(options.hoverAnimation);
        ...
        $t.find("ul > li a").hover(
          function () {
            $(this)
              ...
              .find("> ul")
              .removeClass()
              .addClass(options.submenuAnimation + " animated")
              .one(
      ...
      if (options.hoverColor)
        $("head").append(
          '<style>a[class^="hvr-"]:before{background-color: ' +
            options.hoverColor +
            " !important;}</style>"
        );
      ...
      if (
        options.pushContent &&
        options.mobileDirection == "left" &&
        $t.hasClass("pm_mobile")
      ) {
